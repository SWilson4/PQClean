...
#define SECRET_KEY_BYTES                        PQCLEAN_HQC256_CLEANCRYPTO_SECRETKEYBYTES
#define PUBLIC_KEY_BYTES                        PQCLEAN_HQC256_CLEANCRYPTO_PUBLICKEYBYTES
#define SHARED_SECRET_BYTES                     PQCLEAN_HQC256_CLEANCRYPTO_BYTES
#define CIPHERTEXT_BYTES                        PQCLEAN_HQC256_CLEANCRYPTO_CIPHERTEXTBYTES
