...
//#define PQCLEAN_randombytes PQCLEAN_HQCRMRS192_CLEAN_shake_prng
 ...
 */
void PQCLEAN_HQCRMRS192_CLEAN_vect_set_random_fixed_weight(seedexpander_state *ctx, uint64_t *v, uint16_t weight) {
    ...
    PQCLEAN_HQCRMRS192_CLEAN_seedexpander(ctx, rand_bytes, 4 * weight);
 ...
 * @param[in] ctx Pointer to the context of the seed expander
 */
void PQCLEAN_HQCRMRS192_CLEAN_vect_set_random(seedexpander_state *ctx, uint64_t *v) {
    uint8_t rand_bytes[VEC_N_SIZE_BYTES] = {0};

    PQCLEAN_HQCRMRS192_CLEAN_seedexpander(ctx, rand_bytes, VEC_N_SIZE_BYTES);
 ...
 */
void PQCLEAN_HQCRMRS192_CLEAN_vect_add(uint64_t *o, const uint64_t *v1, const uint64_t *v2, size_t size) {
