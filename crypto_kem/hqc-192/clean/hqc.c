...
void PQCLEAN_HQC192_CLEAN_hqc_pke_encrypt(uint64_t *u, uint64_t *v, uint8_t *m, unsigned char *theta, const unsigned char *pk) {
    ...
    PQCLEAN_HQC192_CLEAN_seedexpander_init(&seedexpander, theta, SEED_BYTES);
    ...
    PQCLEAN_HQC192_CLEAN_vect_set_random_fixed_weight(&seedexpander, r2, PARAM_OMEGA_R);
    ...
    PQCLEAN_HQC192_CLEAN_seedexpander_release(&seedexpander);
}
